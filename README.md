...
- [\[Лекция 2\] Регуляризация](#лекция-2-регуляризация)
  ...
  - [Adam](#adam)
  - [AdamW](#adamw)
- [\[Лекция 3\] Временные ряды](#лекция-3-временные-ряды)
...
# [Лекция 3] Временные ряды

* [Запись](https://disk.360.yandex.ru/d/-i0quAMsXqNabw/2%20%D0%BA%D1%83%D1%80%D1%81%20%D0%9C%D0%9D%D0%90%D0%94-24/%D0%9C%D0%B0%D1%88%D0%B8%D0%BD%D0%BD%D0%BE%D0%B5%20%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%202/1%20%D0%BF%D0%BE%D1%82%D0%BE%D0%BA/3.%2020.09.25%20%D0%9C%D0%B0%D1%88%D0%B8%D0%BD%D0%BD%D0%BE%D0%B5%20%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%202_%D0%9B%D0%B5%D0%BA%D1%86%D0%B8%D1%8F_1%20%D0%BF%D0%BE%D1%82%D0%BE%D0%BA.mp4)

## Определения

**Временной ряд / time series** - последовательность значений, проиндексированных по времени

Если с течением времени мы измеряем не одно значение, а несколько, такой ряд называется **многомерным**

**Регулярный** временной ряд - измерения равномерно распределенны по временной шкале (каждый час/секунда/...)

**Частота** регулярного временного ряда - периодичность записи данных (час/секунда/...)

Пример регулярного и нерегулярного одномерного временного ряда:

<p align="center">
<img src="./src/img/03_lect/regular_irregular_ts.png"  style="width: 50%">
</p>

**Экзогенные / дополнительные / внешние** признаки - те, которые генерируются вне системы. Например, для работы с временным рядом, соответствующем курсу некоторой криптовалюты, можно ввести доп фичу - курс биткоина, потому что скорее всего курс биткоина будет влиять на курс других валют
